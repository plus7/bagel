...
type
  ...
  private
    ...
    procedure SetWidth(Value: Integer);
    //Modified by plus7
    procedure SetUseChevron(const Value: Boolean);
    procedure SetDealWidth(const Value: Integer);
    //End
  protected
    function GetDisplayName: string; override;
  ...
  published
    ...
    property Width: Integer read FWidth write SetWidth;
    //Modified by plus7
    property DealWidth: Integer read FDealWidth write SetDealWidth;
    property UseChevron: Boolean read FUseChevron write SetUseChevron;
    //End
  end;
...
begin
  with PHDNotify(Message.NMHdr)^ do
    case Hdr.code of
      HDN_ITEMCLICK:
        SectionClick(THeaderSection(Sections.FindItemID(Item)));
      HDN_ITEMCHANGED:
...
begin
  ...
  begin
    ...
    try
      ...
      //Modified by plus7
      if Band.UseChevron and (Band.DealWidth > Band.Width) then
...
const
  ...
  RBBS_USECHEVRON = $00000200;    // IE5 style: use chevron (Modified by plus7)
...
begin
  ...
  begin
    ...
    begin
      ...
      //Modified by plus7
      if (GetComCtlVersion >= ComCtlVersionIE5) and Band.UseChevron then
      begin
