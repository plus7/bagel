...
type
  ...
  nsIControllers = interface end;
  nsIVariant = interface end;
  nsIContent = interface end;
  nsIPresShell = interface end;
  nsIFrame = interface end;
  PnsFrameSelection = Pointer;
  nsIContentViewer = interface end;
  nsILayoutHistoryState = interface end;
  nsISecureBrowserUI = interface end;
  nsIDOMStorage = interface end;
  nsDocShellInfoLoadType = PRInt32;
  PnsPresContext = Pointer;
  nsIBoxObject = interface end;
  nsIWordBreaker = interface end;
  nsIFileSpec = interface end;
  nsIDOMOfflineResourceList = interface end;
