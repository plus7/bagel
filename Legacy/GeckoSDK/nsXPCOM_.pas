...
const
  ...
  NS_IDOMNSDOCUMENTSTYLE_IID: TGUID = '{4ecdf254-a21e-47b0-8d72-55da8208299f}';
  ...
  NS_IDOMWINDOW2_IID: TGUID = '{65455132-b96a-40ec-adea-52fa22b1028c}';

  NS_IDOMWINDOWCOLLECTION_IID: TGUID = '{a6cf906f-15b3-11d2-932e-00805f8add32}';

  NS_IDOMWINDOWUTILS_IID: TGUID = '{8a157a4f-a81e-489f-baf2-bc8970d60472}';
  ...
  NS_IPASSWORD_IID: TGUID = '{cf39c2b0-1e4b-11d5-a549-0010a401eb10}';
  ...
  NS_IPRINTSETTINGS_IID: TGUID = '{f1094df6-ce0e-42c9-9847-2f663172c38d}';
  ...
  NS_IPRINTSETTINGS_kInitSavePaperName = 1024;
  NS_IPRINTSETTINGS_kInitSavePaperSizeUnit = 2048;
  NS_IPRINTSETTINGS_kInitSavePaperSizeType = 4096;
  NS_IPRINTSETTINGS_kInitSavePaperData = 8192;
  NS_IPRINTSETTINGS_kInitSavePaperWidth = 16384;
  NS_IPRINTSETTINGS_kInitSavePaperHeight = 32768;
  ...
  NS_IWEBPROGRESS_NOTIFY_ALL = 255;
...
type
  ...
  nsIDOMNSDocumentStyle = interface;
 ...
 *)
  ...
  ['{986c11d0-f340-11d4-9075-0010a4e73d9a}']
    procedure GetInterfaces(out count: PRUint32; out _array: PGUIDArray); safecall;
  ...
  nsIDOMNSDocumentStyle = interface(nsIDOMDocumentStyle)
  ...
  nsIPassword = interface(nsISupports)
  ['{cf39c2b0-1e4b-11d5-a549-0010a401eb10}']
    procedure GetHost(aHost: nsACString); safecall;
    procedure GetUser(aUser: nsAString); safecall;
  ...
  ['{02b0625a-e7f3-11d2-9f5a-006008a6efe9}']
    ...
    procedure GetProfileList(out length: PRUint32; out profileNames: PPWideCharArray); safecall;
  ...
  ['{a63f70c0-148b-11d3-9333-00104ba0fd40}']
    ...
    function Select(const dialogTitle: PWideChar; const text: PWideChar; count: PRUint32; const selectList: PPWideCharArray; out outSelection: PRInt32): PRBool; safecall;
  end;
  ...
  ['{b2c7ed59-8634-4352-9e37-5484c8b6e4e1}']
    ...
    function ContainsNode(node: nsIDOMNode; entirelyContained: PRBool): PRBool; safecall;
  ...
  ['{9a7ca4b0-fbba-11d4-a869-00105a183419}']
    ...
    procedure EnumerateDocumentNames(out aCount: PRUint32; out aResult: PPWideCharArray); safecall;
