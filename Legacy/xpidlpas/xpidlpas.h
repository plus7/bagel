...
extern backend *xpidl_const_dispatch(void);
extern backend *xpidl_forward_dispatch(void);
extern backend *xpidl_typedef_dispatch(void);
extern backend *xpidl_stdcall_dispatch(void);
extern backend *xpidl_safecall_dispatch(void);
...
/* common functions for output-generation functions */
void
write_indent(FILE *outfile);
gboolean
pascal_prolog(TreeState *state);
gboolean
pascal_epilog(TreeState *state);
gboolean
pascal_list(TreeState *state);
void
write_codefrag_line(gpointer data, gpointer user_data);

/* common functions for interface-output functions */
gboolean
...
typedef (*write_method_signature_func_type)(IDL_tree method_tree, FILE *outfile,
                                       const char *className);
extern write_method_signature_func_type write_method_signature_func;
